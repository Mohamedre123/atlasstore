...
> = {
  confirmed: {
    ...
    badge: 'تم التأكيد',
    title: 'طلبك اتأكد ✓',
    body: 'كلّمناك وأكّدت الأوردر، وبدأنا نجهّزه. هنبعتلك رسالة تانية أول ما يخرج للتوصيل.',
  ...
  shipping: {
    ...
    body: `الأوردر مع مندوبنا دلوقتي وهيتواصل معاك قبل ما يوصل. جهّز المبلغ كاش، ومن حقك تتفحّص الأوردر قبل ما تدفع.`,
